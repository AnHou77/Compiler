...
{
  "$end", "error", "$undefined", "SEMICOLON", "identifier", "BOOLEAN",
  "BREAK", "CHAR", "CASE", "CLASS", "CONTINUE", "DEF", "DO", "ELSE",
  "EXIT", "FALSE", "FLOAT", "FOR", "IF", "INT", "NULL", "OBJECT", "PRINT",
  "PRINTLN", "REPEAT", "RETURN", "READ", "STRING", "TO", "TRUE", "TYPE",
  "VAL", "VAR", "WHILE", "INT_VAL", "DOUBLE_VAL", "BOOL_VAL", "STRING_VAL",
  "ID", "$accept", "program", "semi", YY_NULLPTR
};
#endif
